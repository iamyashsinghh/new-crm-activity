                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img style="height: 100px;" class="profile-user-img img-fluid img-circle" src="{{asset($member->profile_image)}}" onerror="this.onerror=null; this.src='{{asset('images/default-user.png')}}'" alt="User profile picture">
                            </div>
                            ...
                            <a href="#" class="btn btn-sm btn-block text-light" style="background-color: var(--wb-renosand);">
                                <b>Login</b>
                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mb-0 float-left">Information</h4>
